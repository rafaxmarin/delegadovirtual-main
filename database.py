...
class Database:
    def __init__(self):
        self.conn = sqlite3.connect('delegado_virtual.db', check_same_thread=False) # type: ignore
    ...
    def registrar_profesor(self, user_id, username):
        self.cursor.execute(
    ...
    def obtener_recaudacion_activa(self, grupo_id):
        self.cursor.execute(
    ...
    def finalizar_recaudacion(self, recaudacion_id):
        self.cursor.execute('UPDATE recaudaciones SET activa = 0 WHERE id = ?', (recaudacion_id,))
        self.conn.commit()
    
    # Métodos para pagos
    def registrar_pago(self, recaudacion_id, estudiante_nombre, fecha_pago):
        self.cursor.execute(
    ...
    def obtener_pagos_recaudacion(self, recaudacion_id):
        self.cursor.execute(
    ...
    def agregar_strike(self, estudiante_id, estudiante_nombre, grupo_id, motivo):
        self.cursor.execute(
    ...
    def obtener_strikes_estudiante(self, estudiante_id, grupo_id):
        self.cursor.execute(
    ...
    def obtener_strikes_profesor(self, profesor_id):
        self.cursor.execute('''
    ...
    def obtener_historial_strikes(self, estudiante_id, grupo_id):
        self.cursor.execute(
    ...
    def agregar_asesoria(self, grupo_id, grupo_nombre, estudiante_nombre, pregunta):
        self.cursor.execute(
    ...
    def obtener_asesorias_pendientes(self, profesor_id):
        self.cursor.execute('''
    ...
    def obtener_contador_asesorias(self, grupo_id):
        fecha_hoy = datetime.now().strftime('%Y-%m-%d')
        self.cursor.execute(
    ...
    # Agregar dentro de la clase Database en database.py
